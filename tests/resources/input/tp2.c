// Sourced from: https://en.cppreference.com/c/language/translation_phases
...
// "[...] A line ending in two backslashes followed by an empty line does not combine three lines into one."
\\
